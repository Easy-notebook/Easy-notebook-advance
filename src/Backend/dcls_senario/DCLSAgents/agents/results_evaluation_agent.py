...
class ResultsEvaluationAgent(BaseAgent):
    def __init__(self, problem_description, context_description, best_five_result, lang: str = "en"):
    ...
    def generate_test_datasets_code(self, multiple_datasets_code, original_dataset_path):
        input_data = BEST_FIVE_DATASETS_TEMPLATE.format(
            original_dataset_path=original_dataset_path,
            multiple_datasets_code=multiple_datasets_code
        )
        
        generated_code = self.answer_parse_json(input_data)
    ...
    def generate_model_evaluation_code(self, model_training_code, train_dataset_path, eval_dataset_path):
        """
